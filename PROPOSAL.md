...
│  ┌─────────────────────────────────────────────────────────────────┐    │
│  │  Data Ingestion Service (Python FastAPI Container)              │    │
│  │  - Polls external APIs for new games/stats                      │    │
│  │  - Validates and structures data                                │    │
│  │  - Publishes to Cloud Pub/Sub topics                            │    │
│  └──────────────────┬──────────────────────────────────────────────┘    │
│                     │                                                   │
│                     │ Publishes                                         │
│                     ▼                                                   │
...
│     ▼               ▼                    ▼                              │ │
│  ┌──────────────┐  ┌──────────────┐  ┌─────────────────────────────┐    │ │
│  │  ML Training │  │   Poisson    │  │   API Gateway Service       │    │ │
│  │  /Inference  │  │   Process    │  │   (FastAPI Container)       │    │ │
│  │   Service    │  │   Modeling   │  │                             │    │ │
│  │              │  │   Service    │  │  - Authentication           │    │ │
│  │  (Python)    │  │   (Python)   │  │  - Rate limiting            │    │ │
│  │              │  │              │  │  - Request routing          │    │ │
│  │  - Process   │  │  - Calculate │  │  - Response caching         │    │ │
│  │    new game  │  │    scoring   │  │  - Model coordination       │    │ │
│  │    data      │  │    rates (λ) │  │                             │    │ │
│  │  - Retrain   │  │  - Live win  │  │                             │    │ │
│  │    models    │  │    prob      │  │                             │    │ │
│  │  - Generate  │  │  - Player    │  │                             │    │ │
...
└─────────────────┼──────────────────────────────────┼─────────────────--─┘ │
         ...
         │  Storage (GCS) │                  │  (Redis Cache)   │           │
         │                │                  │                  │           │
         │  - ML models   │                  │  - Rankings      │           │
         │  - Poisson     │                  │  - Predictions   │           │
         │    parameters  │                  │  - Live game     │           │
         │  - Checkpoints │                  │    probabilities │           │
         │  - Datasets    │                  │  - Event rates   │           │
         └────────────────┘                  └─────────┬────────┘           │
                                                       │                    │
         ┌──────────────────┐                          │                    │
         │   Cloud SQL      │◄───────────────────────-─┘                    │
         ...
         └──────────────────┘                                               │
          ...
          │                                                          │      │
┌─────────┴────────────────────────────────────────────────────────┐ │      │
│              Web Frontend Service (React + nginx Container)      │ │      │
│                                                                  │ │      │
│  - User dashboard                                                │◄┘      │
│  - Season ranking displays                                       │        │
│  - Live game win probability tracker                             │◄────---┘
│  - Player event rate visualizations                              │
